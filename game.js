...
function renderEntities() {
    ...
    layer.innerHTML = '';
    // --- CHARACTER ALIGNMENT: Lowered Y values to align with grass ---
...
function applyDamage(actor, target, move) {
    target.action = 'hurt';
    // --- DAMAGE REBALANCED: ATK scaling is reduced from 0.4 to 0.25 ---
