const ANIMATION_ASSETS = {
    // --- HEROES ---
    archer: { 
        idle: { src: 'assets/archer_idle.png' }, 
        attack1: { src: 'assets/archer_attack1.png' }, 
        attack2: { src: 'assets/archer_attack2.png' }, 
        attack3: { src: 'assets/archer_attack3.png' }, 
        hurt: { src: 'assets/archer_hurt.png' }, 
        die: { src: 'assets/archer_dead.png' } 
    },
    swordsman: { 
        idle: { src: 'assets/swordsman_idle.png' }, 
        attack1: { src: 'assets/swordsman_attack1.png' }, 
        attack2: { src: 'assets/swordsman_attack2.png' }, 
        attack3: { src: 'assets/swordsman_attack3.png' }, 
        hurt: { src: 'assets/swordsman_hurt.png' }, 
        die: { src: 'assets/swordsman_dead.png' } 
    },
    wizard: { 
        idle: { src: 'assets/wizard_idle.png' }, 
        attack1: { src: 'assets/wizard_attack1.png' }, 
        attack2: { src: 'assets/wizard_attack2.png' }, 
        attack3: { src: 'assets/wizard_attack3.png' }, 
        hurt: { src: 'assets/wizard_hurt.png' }, 
        die: { src: 'assets/wizard_dead.png' } 
    },
    enchantress: { 
        idle: { src: 'assets/enchantress_idle.png' }, 
        attack1: { src: 'assets/enchantress_attack1.png' }, 
        attack2: { src: 'assets/enchantress_attack2.png' }, 
        attack3: { src: 'assets/enchantress_attack3.png' }, 
        hurt: { src: 'assets/enchantress_hurt.png' }, 
        die: { src: 'assets/enchantress_dead.png' } 
    },
    knight: { 
        idle: { src: 'assets/knight_idle.png' }, 
        attack1: { src: 'assets/knight_attack1.png' }, 
        attack2: { src: 'assets/knight_attack2.png' }, 
        attack3: { src: 'assets/knight_attack3.png' }, 
        hurt: { src: 'assets/knight_hurt.png' }, 
        die: { src: 'assets/knight_dead.png' } 
    },
    musketeer: { 
        idle: { src: 'assets/musketeer_idle.png' }, 
        attack1: { src: 'assets/musketeer_attack1.png' }, 
        attack2: { src: 'assets/musketeer_attack2.png' }, 
        attack3: { src: 'assets/musketeer_attack3.png' }, 
        hurt: { src: 'assets/musketeer_hurt.png' }, 
        die: { src: 'assets/musketeer_dead.png' } 
    },

    // --- MONSTERS / ENEMIES ---
    firespirit: {
        idle: { src: 'assets/firespirit_idle.png' }, 
        idle2: { src: 'assets/firespirit_idle_2.png' }, 
        walk: { src: 'assets/firespirit_walk.png' }, 
        run: { src: 'assets/firespirit_run.png' },
        attack1: { src: 'assets/firespirit_attack.png' },
        shot: { src: 'assets/firespirit_shot.png' }, 
        charge: { src: 'assets/firespirit_charge.png' }, 
        flame: { src: 'assets/firespirit_flame.png' }, 
        explosion: { src: 'assets/firespirit_explosion.png' },
        hurt: { src: 'assets/firespirit_hurt.png' }, 
        die: { src: 'assets/firespirit_dead.png' }
    },
    plent: {
        idle: { src: 'assets/plent_idle.png' }, 
        walk: { src: 'assets/plent_walk.png' },
        attack1: { src: 'assets/plent_attack_1.png' }, 
        attack2: { src: 'assets/plent_attack_2.png' }, 
        attack3: { src: 'assets/plent_attack_3.png' },
        poison: { src: 'assets/plent_poison.png' }, 
        cloud_poison: { src: 'assets/plent_cloud_poison.png' }, 
        disguise: { src: 'assets/plent_disguise.png' }, 
        attack_disguise: { src: 'assets/plent_attack_disquise.png' },
        hurt: { src: 'assets/plent_hurt.png' }, 
        die: { src: 'assets/plent_dead.png' }
    },
    skeleton: {
        idle: { src: 'assets/skeleton_idle.png' }, 
        walk: { src: 'assets/skeleton_walk.png' }, 
        run: { src: 'assets/skeleton_run.png' },
        attack1: { src: 'assets/skeleton_attack_1.png' }, 
        attack2: { src: 'assets/skeleton_attack_2.png' }, 
        attack3: { src: 'assets/skeleton_attack_3.png' },
        special_attack: { src: 'assets/skeleton_special_attack.png' }, 
        jump: { src: 'assets/skeleton_jump.png' },
        hurt: { src: 'assets/skeleton_hurt.png' }, 
        die: { src: 'assets/skeleton_dead.png' }
    }
};

const CHARACTERS =[
    { 
        id: 0, name: 'Archer', key: 'archer', color: '#2ecc71', isMelee: false, maxHp: 320, atk: 45, spd: 85, maxMp: 150, 
        moves:[
    ...
    { 
        id: 1, name: 'Swordsman', key: 'swordsman', color: '#e74c3c', isMelee: true, maxHp: 400, atk: 55, spd: 60, maxMp: 100, 
        moves:[
    ...
    { 
        id: 2, name: 'Wizard', key: 'wizard', color: '#9b59b6', isMelee: false, maxHp: 240, atk: 65, spd: 55, maxMp: 200, 
        moves:[
    ...
    { 
        id: 3, name: 'Enchantress', key: 'enchantress', color: '#e056fd', isMelee: false, maxHp: 260, atk: 60, spd: 65, maxMp: 180, 
        moves:[
    ...
    { 
        id: 4, name: 'Knight', key: 'knight', color: '#c0c0c0', isMelee: true, maxHp: 500, atk: 40, spd: 40, maxMp: 90, 
        moves:[
    ...
    { 
        id: 5, name: 'Musketeer', key: 'musketeer', color: '#f1c40f', isMelee: false, maxHp: 280, atk: 55, spd: 75, maxMp: 120, 
        moves:[
    ...
    { 
        id: 6, name: 'Fire Spirit', key: 'firespirit', color: '#e67e22', isMelee: false, isEnemy: true, maxHp: 200, atk: 70, spd: 80, maxMp: 150, 
        moves:[
    ...
    { 
        id: 7, name: 'Plent', key: 'plent', color: '#27ae60', isMelee: true, isEnemy: true, maxHp: 550, atk: 45, spd: 45, maxMp: 100, 
        moves:[
    ...
    { 
        id: 8, name: 'Skeleton', key: 'skeleton', color: '#ecf0f1', isMelee: true, isEnemy: true, maxHp: 320, atk: 60, spd: 65, maxMp: 120, 
        moves:[
...
window.onload = () => {
    ...
    for (let char in ANIMATION_ASSETS) {
        for (let anim in ANIMATION_ASSETS[char]) {
            ...
            img.onload = () => { 
                imagesLoaded++; 
                if (imagesLoaded === imagesToLoad) finishLoading(); 
            };
            img.onerror = () => { 
...
function gameLoop(timestamp) {
    ...
    allEnts.forEach(ent => {
        drawModularSprite(`sprite_${ent.uid}`, ent.key, ent.action, !ent.isPlayer, false);
    });
    ...
    for(let i = 0; i < 3; i++) { 
        if(G.selectedTeam[i] !== undefined) {
            drawModularSprite(`preview_sprite_${i}`, CHARACTERS[G.selectedTeam[i]].key, 'idle', false, true);
        }
    }
...
function drawModularSprite(canvasId, charKey, action, flipX, isUI = false) {
    ...
    if (!img || !img.complete || img.naturalWidth === 0) {
        if(!isUI) { 
            ctx.fillStyle = flipX ? '#ff5252' : '#3498db'; 
            ctx.fillRect(canvas.width/2 - 28, canvas.height - 56, 56, 56); 
        }
        return;
    }
    ...
    CHARACTERS.filter(c => !c.isEnemy).forEach(c => {
        ...
        el.innerHTML = `
            <div style="display:flex;justify-content:center;align-items:center;height:100px;">
                <canvas id="select_sprite_${c.id}" width="100" height="100"></canvas>
            </div>
...
const determineRoundWinner = (playerHand, cpuHand) => {
    if (playerHand == "rock") playerHand = 1; 
    else if (playerHand == "paper") playerHand = 2; 
    else if (playerHand == "scissor") playerHand = 3;
    
    if (cpuHand == "rock") cpuHand = 1; 
    else if (cpuHand == "paper") cpuHand = 2; 
    else if (cpuHand == "scissor") cpuHand = 3;
...
const pickCpuHand = () => { 
    ...
    if (cpuHand == 1) return "rock"; 
    else if (cpuHand == 2) return "paper"; 
    else if (cpuHand == 3) return "scissor"; 
}
...
function waitTransition(element) { 
    return new Promise(resolve => { 
        element.addEventListener("transitionend", function handler(e) { 
            const expected =["opacity", "transform", "background-color"]; 
            if (e.target === element && expected.includes(e.propertyName)) { 
...
function handleStrike() { 
    ...
    G.pendingMove = { name: 'Strike', power: G.activeEnt.atk, mpCost: 0, anim: 'attack1' }; 
    startTargeting(); 
}
...
function startTargeting() {
    ...
    targets.forEach(c => {
        if(c.currentHp > 0) {
            ...
            wrap.onclick = () => { 
                clearTargeting(); 
                executeMove(G.activeEnt, c, G.pendingMove); 
            };
        }
    });
}
...
function executeMove(actor, target, move) {
    ...
    pausableTimeout(() => {
        actor.action = 'idle';
        (actor.isPlayer ? G.c.team : G.p.team).forEach(t => { 
...
function applyDamage(actor, target, move) {
    ...
    if (move.isHeal) {
        ...
        if (Math.random() < (move.critChance || 0.05)) { 
    ...
    pausableTimeout(() => { 
        if (target.currentHp > 0) target.action = 'idle'; 
    }, 400);
}
...
function spawnNum(txt, uid, type) {
    ...
    el.innerText = txt;
    el.style.left = (r.left + r.width/2 - sr.left) + 'px'; 
    el.style.top = (r.top - sr.top) + 'px';
    
    s.appendChild(el); 
    pausableTimeout(() => el.remove(), 1200);
}
